...
.center{max-width:600px;margin:40px auto;background:white;padding:30px;border-radius:12px;
box-shadow:0 4px 20px rgba(0,0,0,0.1);text-align:center}
.btn{padding:10px 18px;background:#007bff;color:white;border-radius:8px;text-decoration:none}
</style>
</head>
<body>
<div class="center">
  ...
  <p>Total Paid: <strong>$<?php echo number_format($order['total_amount'],2); ?></strong></p>
