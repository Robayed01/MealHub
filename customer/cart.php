...
<body>
  <div class="header">
    <div>MealHub - Cart</div>
    <div>
      <a class="smalllink" href="restaurants.php" style="color:#fff;text-decoration:none">Continue shopping</a>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <?php else: ?>
            ...
            <tbody>
              <?php foreach ($section['items'] as $it):
                ...
                <tr>
                  ...
                  <td>Tk<?php echo number_format($it['price'], 2); ?></td>
                  <td>
      ...
      <div class="card" style="text-align:right">
        <div class="totalbox">Grand Total: Tk<?php echo number_format($grandTotal, 2); ?></div>
        <!-- Checkout button placeholder -->
        <div style="margin-top:8px">
          <a href="checkout.php"
            style="display:inline-block;padding:10px 16px;background:#28a745;color:#fff;border-radius:8px;text-decoration:none">Proceed
            to Checkout</a>
        </div>
      </div>
    <?php endif; ?>
