...
.msg{background:#e8f3ff;color:#007bff;padding:8px;border-radius:6px;margin-bottom:10px}
...
<br><br>
  ...
  <div class="card">
    ...
    <form method="post">
      ...
      <input class="input" type="text" name="username" value="<?php echo $edit ? htmlspecialchars($edit['username']) : "" ?>" required>
  ...
  <div class="card">
    ...
    <table class="table">
      <thead><tr><th>#</th><th>Username</th><th>Restaurant</th><th>Actions</th></tr></thead>
      <tbody>
        <?php
        $i = 1;
