...
<body>
  <div class="container">
    <a href="orders.php" class="btn" style="background:#557174">← Back to Orders</a>
    <br><br>
        ...
        <tbody>
          ...
          while ($r = $items->fetch_assoc()):
            ...
            <tr>
              ...
              <td>Tk<?php echo number_format((float) $r['price'], 2); ?></td>
              <td>Tk<?php echo number_format($sub, 2); ?></td>
            </tr>
          <?php endwhile; ?>
        </tbody>
      </table>

      <h4>Your subtotal: Tk<?php echo number_format($grand, 2); ?></h4>
