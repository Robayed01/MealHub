...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
  ...
  if ($cnt == 0) {
    ...
    if ($used > 0)
      $msg = "Cannot delete: some food items use this category.";
    else {
...
<body>
  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <form method="post">
        <input class="input" type="text" name="category_name" placeholder="Category name" required
          value="<?php echo $edit ? htmlspecialchars($edit['category_name']) : ''; ?>">
        ...
        <div style="margin-top:8px">
          ...
          <?php if ($edit): ?><a class="btn" href="categories.php"
              style="background:#6c757d;margin-left:8px">Cancel</a><?php endif; ?>
        </div>
      </form>
    </div>
